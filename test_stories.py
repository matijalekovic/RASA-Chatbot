...
add(S02, "what projects have they done?", "S02-04: projects list", expected=["projects", "58", "airport", "portfolio"])
...
add(S04, "what projects does 1PAX do?", "S04-07: projects list", expected=["airport", "58", "project", "portfolio", "terminal"])
...
add(S07, "how many projects have you completed?", "S07-06: projects count", expected=["58", "project", "portfolio", "completed", "delivered"])
...
add(S08, "tell me about the Greyfoot Paris project", "S08-02: Greyfoot Paris", expected=["Greyfoot", "Paris", "urban", "masterplan"])
add(S08, "what was the approach?", "S08-03: approach (slot)", expected=["approach", "design", "urban", "city", "Paris", "masterplan"])
...
add(S12, "tell me about the Greyfoot Paris masterplan", "S12-04: Greyfoot Paris", expected=["Greyfoot", "Paris", "urban", "masterplan"])
...
add(S14, "what is 1PAX's track record with large-scale projects?", "S14-10: projects overview", expected=["project", "58", "airport", "large", "scale", "portfolio", "terminal"])
...
add(S19, "how many projects has 1PAX delivered?", "S19-04: projects count", expected=["58", "project", "portfolio", "delivered", "completed"])
...
def run_tests():
    ...
    outfile = f"test_results/test_stories_{timestamp}.txt"
