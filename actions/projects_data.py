...
PROJECTS = {
    ...
    "greyfoot_paris": {
        "display_name": "Greyfoot – Mixed-Use Urban Development, Paris",
        "category": "Urbanism and Masterplan",
        "location": "Paris, France",
        "year": "Not disclosed",
        "client": "Unibail",
        "architect": "HERAULT ARNOD / Studio 1M2 (urbanism)",
        "partners": "Not disclosed",
        "area": "17,400 m²",
        "capacity": "Not applicable",
        "cost": "Not disclosed",
        "video_url": "",
        "tagline": (
            "A metropolitan gateway that transforms a Parisian 'porte' into a vibrant, mixed-use "
            "urban catalyst."
        ),
        "overview": (
            "Greyfoot is a mixed-use development located at a strategic Parisian 'porte,' conceived as "
            "a catalyst for urban renewal and metropolitan continuity. Awarded First Prize in competition, "
            "the project integrates offices, co-working spaces, housing, and retail into a cohesive and "
            "future-ready urban ensemble. Developed for Unibail, the scheme combines refurbishment and "
            "new construction to redefine the entrance to Espace Champerret. Led by Studio 1M2, the "
            "urban strategy strengthens connections between fragmented city fabrics, transforming a "
            "transitional threshold into an active and recognisable destination — dense, permeable, and "
            "open to its surroundings."
        ),
        "key_challenge": (
            "The primary challenge was to reconcile multiple programmes and scales within a complex "
            "urban edge condition. As a 'Paris door,' the site demanded both metropolitan presence and "
            "local sensitivity. The project needed to bridge existing neighbourhoods, enhance pedestrian "
            "continuity, and integrate new functions without disrupting the established identity of "
            "the area."
        ),
        "approach": (
            "The masterplan articulates volumes to create urban porosity, allowing public flows to "
            "traverse the site while structuring clear hierarchies between public, semi-public, and "
            "private realms. Refurbishment and new construction are carefully balanced: existing "
            "structures are reinterpreted to extend their life cycle, while new volumes introduce a "
            "strong architectural identity that signals arrival. The mixed-use composition promotes "
            "vertical and horizontal diversity — retail animates the ground plane, workplaces foster "
            "innovation and collaboration, and housing introduces permanence and daily life. Landscaped "
            "terraces, shaded passages, and integrated green elements soften the metropolitan scale "
            "and enhance environmental comfort."
        ),
        "five_star_detail": (
            "N/A — this project does not pursue a 5-Star certification. "
            "For 1PAX's 5-Star airport design expertise, ask about the Sofia Airport project."
        ...
        "sustainability": (
            "Greyfoot embeds sustainability through adaptive reuse — existing structures are "
            "refurbished and extended rather than demolished, preserving embodied carbon and extending "
            "building life cycles. Life-cycle thinking informs material choices and structural strategies "
            "throughout. Landscaped terraces, shaded passages, and integrated green elements manage "
            "stormwater and improve microclimate at the metropolitan 'porte,' while the mixed-use, "
            "transit-oriented programme promotes walkable, low-carbon urban living."
        ),
        "status": "Competition entry — 1st Prize (year not disclosed)",
        "tender_result": "Winner of design competition — 1st Prize",
        "scope": "Urban design and architecture — 17,400 m² mixed-use development at a strategic Parisian 'porte', combining offices, co-working, housing, retail, and public space",
        "program": (
            "• Offices and co-working spaces\n"
            "• Housing — introducing residential permanence at a transit threshold\n"
            "• Retail at ground floor animating the public realm\n"
            "• Landscaped terraces and shaded passages\n"
            "• Refurbishment of existing structures combined with new architectural volumes\n"
            "• Urban porosity — public flows traversing the site through carefully articulated volumes"
        ),
        "fun_facts": (
            "• Greyfoot is located at one of Paris's 'portes' — the historic gateways where the Boulevard Périphérique meets the city, areas long treated as leftover urban space but now seen as prime regeneration sites.\n"
            "• The project refurbishes existing Espace Champerret structures rather than demolishing them — an approach that won the competition and preserves significant embodied energy.\n"
            "• 1PAX (as Studio 1M2) led the urbanism strategy alongside Hérault Arnod as architect — a collaboration typical of the integrated urban-architectural practice that defines 1PAX's working method."
        ),
    },
